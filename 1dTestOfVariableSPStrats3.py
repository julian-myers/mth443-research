...
def generate_centers(
    ...
    # TO DO: use switch the center strategy that reduces the
    # error near bounds
    # However, for the sake of science it might be better to
...
def main() -> None:
    ...
    # do this.
    # could try just keeping all between a fixed interval
    CON_SHAPE = 2.4
    ...
    with open("ConditionNumbers3.csv", mode='w', newline='') as file:
        writer = csv.writer(file)
        writer.writerow([
            "CSP",
            "LSP",
    ...
    with open("MaxErrors3.csv", mode="w", newline="") as file:
        writer = csv.writer(file)
        writer.writerow([
            "CSP",
            "LSP",
